...
class Object extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('service_entity_id, type_object_id', 'numerical', 'integerOnly'=>true),
                    ...
                    array('object_id, service_entity_id, type_object_id, object_number, object_min_warn, object_max_warn, object_address, object_latitude, object_longitude', 'safe', 'on'=>'search'),
            );
    }
    ...
    public function relations()
    {
            ...
            return array(
                    ...
                    'entitySuscriptors' => array(self::MANY_MANY, 'EntitySuscriptor', 'object_suscriptor(object_id, company_suscriptor_id)'),
                    ...
                    'typeMeters' => array(self::MANY_MANY, 'TypeMeter', 'type_meter_object(object_id, type_meter_id)'),
            );
    }
